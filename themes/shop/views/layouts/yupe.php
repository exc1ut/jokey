		...
		<div class="header_right">
            ...
            <?php $this->widget('application.modules.menu.widgets.MenuWidget', ['name' => 'top-menu-' . Yii::app()->language]); ?>
				<!-- <ul class="topMenu">
					...
					<li>
						<a href="news/index.html">Новости Jokey</a>
					</li>
					<li>
						<a href="products/index.html">Продукция</a>
					</li>
					<li>
						<a href="downloads/index.html">Скачать</a>
					</li>
					<li>
						<a href="contacts/index.html">Контакты</a>
					</li>
					<li>
						<a href="delivery/index.html">Оплата и доставка</a>
					</li>
				</ul> -->
			</div>
		</div>
...
<?php
Yii::app()->getClientScript()->registerScriptFile($this->mainAssets . '/js/jquery.js');
